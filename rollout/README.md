...
conda activate paos
python -m rollout --config rollout/configs/pipergo2_manipulation.json --gui --port 8765
```

Headless:

```bash
python -m rollout --config rollout/configs/pipergo2_manipulation.json --headless --port 8765
```
