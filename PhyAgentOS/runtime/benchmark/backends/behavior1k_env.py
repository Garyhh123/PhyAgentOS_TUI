...
from PhyAgentOS.runtime.benchmark.schemas import BenchmarkSpec
...
def phyagent_repo_root() -> Path:
    """Repo root so ``import PhyAgentOS...`` works in behavior conda subprocess."""
    from PhyAgentOS.paths import REPO_ROOT
