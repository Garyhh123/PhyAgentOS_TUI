...
policies:
  - id: dummy_baseline
    ...
    hydra_policy: local
    hydra_overrides:
      model._target_: PhyAgentOS.eval_compat.demo_wiggle_policy.DemoWigglePolicy
  ...
  - id: b1k_websocket
    ...
    action_dim: 23
    chunk_size: 1
    notes: Start scripts/start_b1k_openpi_policy_server.sh with CHECKPOINT_DIR set. Uses OmniGibson WebsocketPolicyServer protocol.
