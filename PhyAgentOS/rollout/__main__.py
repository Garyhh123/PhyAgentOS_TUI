...
def _ensure_import_paths() -> None:
    for root in (str(_REPO_ROOT), str(_PACKAGE_ROOT)):
...
def main() -> int:
    ...
    default_config = _PACKAGE_ROOT / "rollout/configs/pipergo2_manipulation.json"
    parser.add_argument(
        "--config",
        type=str,
        default=str(default_config),
        help="Runner JSON config (default: PhyAgentOS/rollout/configs/pipergo2_manipulation.json)",
    )
